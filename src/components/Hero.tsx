...
import blurCyanImage from '@/images/blur-cyan.svg'
import blurIndigoImage from '@/images/blur-indigo.svg'
...
const tabs = [
  { name: 'check_level_of_detail.sql', isActive: true },
  { name: 'active_customers.sql', isActive: false },
]
          ...
          <div className="relative z-10 md:text-center lg:text-left">
            ...
            <div className="relative">
              <p className="inline bg-gradient-to-r from-indigo-200 via-sky-400 to-indigo-200 bg-clip-text font-display text-5xl tracking-tight text-transparent">
                Institute of Data Architecture
              </p>
              <p className="mt-3 text-2xl tracking-tight text-slate-400">
                Empower your customers to make data-driven decisions, and
                harness the flexibility and resilience of modern data
                architecture.
              </p>
              <div className="mt-8 flex gap-4 md:justify-center lg:justify-start">
                <Button href="/institute-of-data-architecture/your-learning-journey">
