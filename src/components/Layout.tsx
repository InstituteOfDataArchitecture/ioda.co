...
function Header() {
  ...
  return (
    ...
    >
      ...
      <div className="relative flex basis-0 justify-end gap-3 sm:gap-4 md:flex-grow">
        <ThemeSelector className="relative z-10" />
        <Link
          href="https://github.com/InstituteOfDataArchitecture"
          target="_blank"
          className="group"
          aria-label="GitHub"
        >
        ...
        <Link
          href="https://www.youtube.com/@InstituteofDataArchitecture"
          target="_blank"
          className="group"
          aria-label="YouTube"
        >
        ...
        <Link
          href="https://discord.gg/DDpVCJuB"
          target="_blank"
          className="group"
          aria-label="Discord"
        >
